...
<body class="hompg ser-pg contact contact-pg privacy">
    ...
    <main class="app-container">
        ...
        <section class="formwrap">
            <div class="container">
                <div class="row">
                    <div class="col-md-6 bg-clr  my-auto">
                        <div class="imgwrp">
					...
					<p class="main-pera">Feel free to give us a call, write to us, or complete the contact form at the bottom of this page.
					<br>
					Call (Toll Free): +1 310 862 6398 Email: support@writingexpertshub.com</p>
				</div> -->
                        <div class="form-wrp btmfrom">
                            <div class="txtwrp">
                                <h2 class="main-heading" style="color: #000;">
                            ...
                            <div class="cntct-form formwrp">
                                ...
                                <form id="fomm" action="thank-you/" method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="lablewrp">
                                                <input type="" name="email" placeholder="Enter email here" required>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="lablewrp">
                                                <input type="" name="brief" placeholder="Brief" required>
                                            </div>
                                        </div>
                                        <!-- <div class="col-md-6">
                                            <div class="lablewrp">
                                                <select name="extra[service]" id="packages" class="valid safari_only"
                                                    ...
                                                    <optgroup>
                                                        <option value="Content Writing" pack="0" class="colr">Ghost
                                                            writing</option>
                                                        <option value="Publishin" pack="0" class="colr">Publishing
                                                        </option>
                                                        <option value="Editing" pack="0" class="colr">Editing</option>
                                                        <option value="Proofreading" pack="0" class="colr">Proofreading
                                                        </option>
                                                        <option value="Book Cover Design" pack="0" class="colr">Book
                                                            Cover Design</option>
                                                        <option value="Illustration Design" pack="0" class="colr">
                                                            Illustration Design</option>
                                                        <option value="Book Marketing" pack="0" class="colr">Book
                                                            Marketing</option>
                                                        <option value="Script Writing" pack="0" class="colr">Script
                                                            Writing</option>
                                                    </optgroup>
                                                </select>
                                            </div>
                                        ...
                                        <!-- <div class="col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox8" type="checkbox" name="extra[genre]"
                                                        value="Memoir / Autobiography" checked="checked">
                                                    <label for="checkbox8">Memoir / Autobiography</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox9" type="checkbox" name="extra[genre]"
                                                        value="General Nonfiction">
                                                    <label for="checkbox9">General Nonfiction</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox10" type="checkbox" name="extra[genre]"
                                                        value="Adult Fiction">
                                                    <label for="checkbox10">Adult Fiction</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox11" type="checkbox" name="extra[genre]"
                                                        value="Biography">
                                                    <label for="checkbox11">Biography</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox12" type="checkbox" name="extra[genre]"
                                                        value="Personal Development">
                                                    <label for="checkbox12">Personal Development</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox13" type="checkbox" name="extra[genre]"
                                                        value="Young Adult Fiction">
                                                    <label for="checkbox13">Young Adult Fiction</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox14" type="checkbox" name="extra[genre]"
                                                        value="Business">
                                                    <label for="checkbox14">Business</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox15" type="checkbox" name="extra[genre]"
                                                        value="Religious">
                                                    <label for="checkbox15">Religious</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox16" type="checkbox" name="extra[genre]"
                                                        value="Children's Literature">
                                                    <label for="checkbox16">Children's Literature</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox17" type="checkbox" name="extra[genre]"
                                                        value="Self-Help">
                                                    <label for="checkbox17">Self-Help</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox18" type="checkbox" name="extra[genre]"
                                                        value="Spiritual">
                                                    <label for="checkbox18">Spiritual</label>
                                                </div>
                                                <div class="check-list col-lg-6">
                                                    <input id="checkbox19" type="checkbox" name="extra[genre]"
                                                        value="I Don't Know">
                                                    <label for="checkbox19">I Don't Know</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="lablewrp">
                                                <input class="btnwrp" type="Submit" name="" value="Submit">
