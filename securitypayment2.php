...
<head>
  <title>Get My Logo Done | Secure Payment</title>
    <meta name="description" content=""> 
   
 
	<?php include_once('includes/paymentstyle.php');?>
   ...
   <div class="main_nav">
        <div class="container">   
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand logo" href="index.php" data-aos="fade-down" data-aos-duration="1000"> <img style="width:100%;" src="img/logo1.png" alt="logo"> </a>
				...
				<div class="cardInfo">
					<div class="card myCardPay" >
						<div class="card-header text-center text-black">
							<h2 class="card-heading" style="color:black;">Invoice from Get My Logo Done</h2>
